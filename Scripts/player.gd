...
#		d = 0
	...
	var jump_attempt = Input.is_action_pressed("ui_accept")
	...
	if shoot_attempt and not prev_shoot:
		...
		var bullet = preload("res://Assets/Itens/Bullet/bullet.scn").instance()
...
func _on_Area_body_entered(body):
	if (body is preload("res://Scripts/bullet.gd")):
		#colisaoDano = true
		translation.y = -2
